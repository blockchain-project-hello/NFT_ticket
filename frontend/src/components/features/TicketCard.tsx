...
export function TicketCard({ tokenId, eventName, seller, price, status, onBuy, isLoading }: TicketCardProps) {
  return (
    <div className="glass-card rounded-2xl overflow-hidden group transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_10px_40px_-10px_rgba(139,92,246,0.3)]">
      <div className="h-40 bg-gradient-to-br from-gray-900 to-gray-800 relative flex items-center justify-center border-b border-white/5">
