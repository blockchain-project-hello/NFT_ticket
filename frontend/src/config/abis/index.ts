export const TicketNFTABI = [
  ...
  {"type":"function","name":"listForResale","inputs":[{"name":"tokenId","type":"uint256"},{"name":"askPrice","type":"uint256"}],"outputs":[],"stateMutability":"nonpayable"},
  {"type":"function","name":"delistFromResale","inputs":[{"name":"tokenId","type":"uint256"}],"outputs":[],"stateMutability":"nonpayable"},
  {"type":"function","name":"resaleTicket","inputs":[{"name":"tokenId","type":"uint256"},{"name":"maxPrice","type":"uint256"},{"name":"nonce","type":"uint256"},{"name":"deadline","type":"uint256"},{"name":"signature","type":"bytes"}],"outputs":[],"stateMutability":"payable"},
  ...
  {"type":"function","name":"events","inputs":[{"name":"eventId","type":"uint256"}],"outputs":[{"name":"name","type":"string"},{"name":"basePrice","type":"uint256"},{"name":"totalSupply","type":"uint256"},{"name":"ticketsMinted","type":"uint256"},{"name":"organizer","type":"address"},{"name":"eventDate","type":"uint256"},{"name":"exists","type":"bool"}],"stateMutability":"view"},
  {"type":"function","name":"resaleListings","inputs":[{"name":"tokenId","type":"uint256"}],"outputs":[{"name":"isListed","type":"bool"},{"name":"askPrice","type":"uint256"}],"stateMutability":"view"},
  {"type":"event","name":"EventCreated","inputs":[{"indexed":true,"name":"eventId","type":"uint256"},{"indexed":false,"name":"name","type":"string"},{"indexed":true,"name":"organizer","type":"address"},{"indexed":false,"name":"basePrice","type":"uint256"},{"indexed":false,"name":"totalSupply","type":"uint256"}],"anonymous":false},
  {"type":"event","name":"TicketMinted","inputs":[{"indexed":true,"name":"tokenId","type":"uint256"},{"indexed":true,"name":"eventId","type":"uint256"},{"indexed":true,"name":"minter","type":"address"}],"anonymous":false},
  {"type":"event","name":"TicketListed","inputs":[{"indexed":true,"name":"tokenId","type":"uint256"},{"indexed":true,"name":"owner","type":"address"},{"indexed":false,"name":"price","type":"uint256"}],"anonymous":false},
...
export const CrowdfundEscrowABI = [
  {"type":"function","name":"createCampaign","inputs":[{"name":"eventId","type":"uint256"},{"name":"goal","type":"uint256"},{"name":"deadline","type":"uint256"}],"outputs":[],"stateMutability":"nonpayable"},
  ...
  {"type":"function","name":"getCampaign","inputs":[{"name":"campaignId","type":"uint256"}],"outputs":[{"name":"eventId","type":"uint256"},{"name":"goal","type":"uint256"},{"name":"funded","type":"uint256"},{"name":"deadline","type":"uint256"},{"name":"state","type":"uint8"}],"stateMutability":"view"},
  ...
  {"type":"event","name":"CampaignCreated","inputs":[{"indexed":true,"name":"campaignId","type":"uint256"},{"indexed":true,"name":"eventId","type":"uint256"},{"indexed":true,"name":"organizer","type":"address"},{"indexed":false,"name":"goal","type":"uint256"},{"indexed":false,"name":"deadline","type":"uint256"}],"anonymous":false},
  {"type":"event","name":"CampaignBacked","inputs":[{"indexed":true,"name":"campaignId","type":"uint256"},{"indexed":true,"name":"backer","type":"address"},{"indexed":false,"name":"amount","type":"uint256"}],"anonymous":false},
...
export const ESCROW_ABI = CrowdfundEscrowABI;
